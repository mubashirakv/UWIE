...
#     print("Choose the type of file:")
#     print("1. Image")
#     print("2. Video")

#     file_type = input("Enter the number (1 or 2): ")

#     if file_type == "1":
#         # Image processing
#         source_path = input("Enter the source image path: ")
...
#     elif file_type == "2":
#         # Video processing
#         source_path = input("Enter the source video path: ")
#         output_path = input("Enter the output video path: ")

#         for item in analyze_video(source_path, output_path):
#             if type(item) == dict:
#                 video_data = item
...
def vvddoo(source_path, output_path):
    for item in analyze_video(source_path, output_path):
            if type(item) == dict:
                video_data = item
